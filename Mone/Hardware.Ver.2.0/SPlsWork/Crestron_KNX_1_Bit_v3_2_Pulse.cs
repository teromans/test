...
namespace UserModule_CRESTRON_KNX_1_BIT_V3_2_PULSE
{
    public class UserModuleClass_CRESTRON_KNX_1_BIT_V3_2_PULSE : SplusObject
    {
...
public void UPDATEONEBITVALUECALLBACK ( ushort VALUE ) 
    ...
    try
    {
        ...
        if ( Functions.TestForTrue  ( ( VALUE)  ) ) 
            ...
            Functions.Pulse ( 10, ON_FEEDBACK ) ; 
            } 
        
        else 
            { 
            __context__.SourceCodeLine = 112;
            Functions.Pulse ( 10, OFF_FEEDBACK ) ; 
            } 
...
public UserModuleClass_CRESTRON_KNX_1_BIT_V3_2_PULSE ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
